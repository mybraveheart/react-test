/**
 * Base on https://github.com/umijs//opt/gitlab/cn-monthly-frontend/node_modules/_umi-request@1.2.19@umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from '/opt/gitlab/cn-monthly-frontend/node_modules/_umi-request@1.2.19@umi-request';
// @ts-ignore
...
import useUmiRequest from '/opt/gitlab/cn-monthly-frontend/node_modules/_@umijs_use-request@1.4.2@@umijs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from '/opt/gitlab/cn-monthly-frontend/node_modules/_@umijs_use-request@1.4.2@@umijs/use-request/lib/types';
